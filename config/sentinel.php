...
return [
    ...
    */
    ...
    'subjects' => [
        'welcome'        => 'Loan Alert | Account Registration Confirmation',
    ...
    */
    ...
    'routing' => [
        'session_store'                => ['route' => 'admin.dashboard'],
        'session_destroy'              => ['action' => 'Acl\Admin\SessionController@create'],
        'registration_complete'        => ['route' => 'sentinel.login'],
        'registration_activated'       => ['route' => 'sentinel.login'],
        'registration_resend'          => ['route' => 'sentinel.login'],
        'registration_reset_triggered' => ['route' => 'sentinel.login'],
        'registration_reset_invalid'   => ['route' => 'sentinel.login'],
        'registration_reset_complete'  => ['route' => 'sentinel.login'],
        'users_invalid'                => ['route' => 'sentinel.login'],
    ...
    */
    ...
    'view' => [
        'session_login' => 'acl.admin.sessions.login',
        'user_register' => 'acl.admin.users.register'
    ],
    ...
    */
    ...
    'layout' => 'acl.admin.layouts.default',
    ...
    */
    ...
    'emails' => [
        'views' => [
            'welcome' => 'mails.admins.userActivation',
            'reset' => 'acl.admin.emails.reset'
        ]
    ]
