...
<!-- Page Header -->
@section('header')Edit Client @stop

<!-- Page Description -->
@section('desc')Edit Client's Details @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('clients.update', array($client->id)) }}" method="POST" accept-charset="UTF-8">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="first_name" value="{{ $client->first_name }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="middle_name" value="{{ $client->middle_name }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="last_name" value="{{ $client->last_name }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <select class="form-control" name="office">
                                                ...
                                                @foreach($offices as $office)
                                                    <option value="{{ $office->id }}" {{ $client->office_id == $office->id ? 'selected' : '' }}>{{ $office->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="phone_number" value="{{ $client->phone_number }}" type="number" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="phone_number_2" value="{{ $client->phone_number_2 }}" type="number" class="form-control">
                                        </div>
                                    </div>
