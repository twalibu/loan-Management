...
<!-- Page Header -->
@section('header')Add Loan Overdue Penalt @stop

<!-- Page Description -->
@section('desc')Create New Loan Overdue Penalt @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('loanOverdues.store') }}" method="POST" accept-charset="UTF-8">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                    
                    <div class="wizard-header">
                        <h3 class="wizard-title">
                            New Loan Overdue Penalt Registration
                        </h3>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="penalt" type="number" value="{{ old('penalt') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
