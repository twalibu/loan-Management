...
<!-- Page Title -->
@section('title')Staff Types @stop
...
<!-- Page Header -->
@section('header')Edit Staff Type @stop

<!-- Page Description -->
@section('desc')Edit Staff Type Details @stop

<!-- Active Link -->
@section('active')Staff Types @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('types.update', array($type->id)) }}" method="POST" accept-charset="UTF-8">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            <label class="control-label">Staff Type Name</label>
