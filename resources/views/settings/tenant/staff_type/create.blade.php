...
<!-- Page Header -->
@section('header')Add Staff Type @stop

<!-- Page Description -->
@section('desc')Create New Staff Type @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('types.store') }}" method="POST" accept-charset="UTF-8">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                    
                    <div class="wizard-header">
                        <h3 class="wizard-title">
                            New Staff Type Registration
                        </h3>
