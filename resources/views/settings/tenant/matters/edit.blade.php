...
<!-- Page Header -->
@section('header')Edit Case Matter @stop

<!-- Page Description -->
@section('desc')Edit Case Matter Details @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('matters.update', array($matter->id)) }}" method="POST" accept-charset="UTF-8">
                    <input type="hidden" name="_method" value="PUT">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                    
                    <div class="wizard-header">
                        <h3 class="wizard-title">
                            Edit Case Matter Details
                        </h3>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="name" type="text" value="{{ $matter->name }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
