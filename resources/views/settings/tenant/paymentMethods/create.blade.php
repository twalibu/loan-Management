...
<!-- Page Header -->
@section('header')Add Payment Method @stop

<!-- Page Description -->
@section('desc')Create New Payment Method @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('paymentMethods.store') }}" method="POST" accept-charset="UTF-8">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="account_number" type="text" value="{{ old('account_number') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
