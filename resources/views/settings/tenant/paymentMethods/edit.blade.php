...
<!-- Page Header -->
@section('header')Edit Payment Method @stop

<!-- Page Description -->
@section('desc')Edit Payment Method Details @stop
    ...
    <div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('paymentMethods.update', array($method->id)) }}" method="POST" accept-charset="UTF-8">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="name" type="text" value="{{ $method->name }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="account_number" type="text" value="{{ $method->account_number }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
