...
<!-- Page Header -->
@section('header')Add Subscription Type @stop

<!-- Page Description -->
@section('desc')Create New Subscription Type @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('subscriptions.store') }}" method="POST" accept-charset="UTF-8">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                    
                    <div class="wizard-header">
                        <h3 class="wizard-title">
                            New Subscription Type Registration
                        </h3>
