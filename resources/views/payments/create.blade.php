                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <select class="form-control" name="loan">
                                                ...
                                                @foreach($summaries as $summary)
                                                    <option value="{{ $summary->loan->id }}" {{ old('loan') == $summary->loan->id ? 'selected' : '' }}>Loan ID: {{ $summary->loan->loan_identity }} | {{ $summary->loan->client->first_name }} {{ $summary->loan->client->last_name }} | {{ $summary->loan->type->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
