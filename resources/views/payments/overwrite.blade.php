...
<!-- Page Title -->
@section('title')Loan Overwrite @stop
...
<!-- Page Header -->
@section('header')Loan Overwrite @stop

<!-- Page Description -->
@section('desc')Overwrite Loan Payment @stop

<!-- Active Link -->
@section('active')Loan Overwrite @stop
                ...
                <form action="{{ route('payment.overwrite') }}" method="POST" accept-charset="UTF-8">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="details">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="info-text">Loan ID: {{ $loan->loan_identity }} | {{ $loan->client->first_name }} {{ $loan->client->middle_name }} {{ $loan->client->last_name }}</h4>
                                </div>
                                <div class="col-sm-10">
