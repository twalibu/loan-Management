...
<!-- Page Header -->
@section('header')Edit Office @stop

<!-- Page Description -->
@section('desc')Edit Office Details @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('offices.update', array($office->id)) }}" method="POST" accept-charset="UTF-8">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="name" value="{{ $office->name }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
