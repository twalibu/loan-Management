            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        ...
                        @endif
                        <button class="btn red lighten-1 action_confirm" href="{{ route('sentinel.users.destroy', array($user->hash)) }}" data-token="{{ csrf_token() }}" data-method="delete"><i class="mdi-content-remove-circle left"></i>Delete</button>
                    </td>
                </tr>
            @endforeach
        </tbody>
