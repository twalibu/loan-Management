...
<!-- Page Header -->
@section('header')Edit Contact Group @stop

<!-- Page Description -->
@section('desc')Edit Contact Group Details @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('bulk.update', array($group->id)) }}" method="POST" accept-charset="UTF-8" >
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="name" value="{{ $group->name }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
