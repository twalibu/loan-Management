...
<!-- Page Header -->
@section('header')Add Contact To Group @stop

<!-- Page Description -->
@section('desc')Adding Contacts To Group @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('bulks.post.add', array($group->id)) }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="wizard-header">
                        ...
                        <h5>Contact Count: {{ number_format($group->contacts->count(), 0) }}</h5>
                    </div>
