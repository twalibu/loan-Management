...
class UserController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->viewFinder('acl.admin.users.index', ['users' => $users]);
    }
    ...
    {
        return $this->viewFinder('acl.admin.users.create');
    }
    ...
    public function store(UserCreateRequest $request)
    {
        ...
        $message = ($result->getPayload()['activated'] ? trans('User Created & Activated') : trans('User Created'));
    ...
    public function show($hash)
    {
        ...
        return $this->viewFinder('acl.admin.users.show', ['user' => $user]);
    }
    ...
    public function edit($hash)
    {
        ...
        return $this->viewFinder('acl.admin.users.edit', [
            'user' => $user,
            'groups' => $groups
        ]);
    }
