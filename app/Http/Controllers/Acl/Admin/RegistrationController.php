...
class RegistrationController extends BaseController
{
    ...
    public function registration()
    {
        ...
        if (! config('sentinel.registration', false)) {
            return $this->redirectTo(['route' => 'sentinel.login'], ['error' => trans('Sorry, You Can Not Register Here!')]);
        }

        // All clear - show the registration form.
        return $this->viewFinder(config('sentinel.view.user_register', 'acl.admin.users.register'));
    }
    ...
    {
        return $this->viewFinder('acl.admin.users.resend');
    }
    ...
    {
        return $this->viewFinder('acl.admin.users.forgot');
    }
    ...
    public function passwordResetForm($hash, $code)
    {
        ...
        return $this->viewFinder('acl.admin.users.reset', [
            'hash' => $hash,
            'code' => $code
        ]);
    }
